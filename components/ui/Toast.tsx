...
const Toast: React.FC<{ message: ToastMessage, onDismiss: (id: string) => void }> = ({ message, onDismiss }) => {
  return (
    <motion.div
      ...
      className="mb-4 flex w-full max-w-sm items-start space-x-4 rounded-lg p-4 shadow-lg glass-card"
    >
      ...
      <div className="flex-shrink-0">
        <button
          ...
          className="inline-flex rounded-md text-gray-400 hover:text-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900"
        >
